...
### 2. detect.py
说明：通过Face++过滤不含人脸的图片，使用此功能请注册Face++，Face++有免费额度，增加并发量才收费，免费的足够用，如需更优质的图片，请右转https://github.com/yanjingao/SNH48G_Album  
...
### 4. 图片资源.zip
说明：采集到的所有图片链接，采集于2020年3月17日，不想运行或者运行有问题的可直接使用此资源，用download.py或者支持多行链接下载的下载器（比如迅雷）下载图片
